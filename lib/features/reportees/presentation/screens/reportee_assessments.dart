...
class ReporteeAssessments extends ConsumerStatefulWidget {
  const ReporteeAssessments(
  ...
  @override
  ConsumerState<ReporteeAssessments> createState() => _ExpandableState();
}

class _ExpandableState extends ConsumerState<ReporteeAssessments> {
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            contentSuccess(String msg) {
              ...
              widget.onAdd(
                  true, employee, appraisals, "EmployeeAssessmentsGrid");
              return const ReporteesNavigation();
            }
