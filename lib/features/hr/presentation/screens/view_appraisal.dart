...
class ViewAppraisal extends ConsumerStatefulWidget {
  const ViewAppraisal({
    super.key,
  ...
  final void Function(bool flg, List<EmployeeMaster> selectedEmployee,
      List<AssessmentMaster> selectedAppraisal, String pageName) onAdd;
  final void Function(
          bool flg, List<AssessmentMaster> selectedAppraisal, String pageName)
      onView;

  @override
  ConsumerState<ViewAppraisal> createState() {
    return _ViewAppraisalState();
  }
}

class _ViewAppraisalState extends ConsumerState<ViewAppraisal> {
          ...
          ElevatedButton(
            onPressed: () {
              try {
                ...
                widget.onAdd(true, [], [], "EmployeeAppraisalsGrid");
              } catch (e) {
                //error code
              }
            },
